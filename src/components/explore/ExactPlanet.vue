<template>
  <div class="random-planet-container">
    ...
    <div
      v-if="exactPlanet"
      class="random-planet"
      :style="planetStyle(exactPlanet)"
      @click="selectPlanet(exactPlanet)"
      @mouseenter="showTooltip(exactPlanet, $event)"
      @mouseleave="hideTooltip"
    >
      <div class="planet-content">
        <div class="planet-title">{{ exactPlanet.contentTitle }}</div>
        <div class="planet-badge">✨ 定向星球</div>
      </div>
...
// 定向星球数据
const exactPlanet = computed(() => props.planet)
